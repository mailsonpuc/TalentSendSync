...
namespace TalentSendSync.Infrastructure.Migrations
{
    ...
    [Migration("20260922201400_AddIdentityRefreshTokens")]
    partial class AddIdentityRefreshTokens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TalentSendSync.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TalentSendSync.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
